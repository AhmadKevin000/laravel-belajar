<x-layout>
    ...
    <article class="py-8 max-wscreen-md border-b border-gray-300">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro incidunt a fuga, neque molestiae ab fugiat! Eligendi obcaecati temporibus molestiae quae unde voluptates corrupti commodi error culpa eveniet, perferendis magnam?</p>
    </article>
    <article class="py-8">
